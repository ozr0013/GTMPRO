...
- **All hands (submission)** — rehearse `docs/DEMO.md` twice, record the 3–5 min video, final README pass. Live *cloud* validation (`npm run smoke` with real Claude+GPT keys) is still unrun; live *local* is validated.
